...
## 京喜工厂定时
sed -i "s/20 \* \* \* \* node \/scripts\/jd_dreamFactory.js/30 1,2,3,6-23\/1 \* \* \* node \/scripts\/jd_dreamFactory.js/g" /scripts/docker/merged_list_file.sh
sed -i "s/20 \* \* \* \* sleep \$((RANDOM % \$RANDOM_DELAY_MAX)); node \/scripts\/jd_dreamFactory.js/30 1,2,3,6-23\/1 \* \* \* sleep \$((RANDOM % \$RANDOM_DELAY_MAX)); node \/scripts\/jd_dreamFactory.js/g" /scripts/docker/merged_list_file.sh
