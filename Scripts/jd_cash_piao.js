...
const inviteCodes = [
  `eU9YaOvnM_4k9WrcnnAT1Q@eU9Yar-3M_8v9WndniAQhA@fkFwauq3ZA@eU9YaOiwMKklo2eGyCFG1A`
]
if ($.isNode()) {
...
function getAuthorShareCode(url = "https://raw.githubusercontent.com/FKPYW/SomeScripts/master/Scripts/jd_cash.json") {
  return new Promise(resolve => {
    $.get({url, headers:{
...
function getAuthorShareCode2(url = "https://raw.githubusercontent.com/FKPYW/SomeScripts/master/Scripts/jd_cash.json") {
  return new Promise(resolve => {
    $.get({url, headers:{
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      }}, async (err, resp, data) => {
